...
function App() {
  ...
  const [masterDataColliGrossWeight, setMasterDataColliGrossWeight] = useState(0);
  ...
  const articleNetWeightVariation = Number(masterDataArticleNetWeight - articleNetWeight).toFixed(3);
          ...
          <ul>
            ...
            <li className="flex">
              ...
              <input
                ...
                value={`${Number(masterDataArticleGrossWeight).toFixed(3)}`}
                onChange={(e) =>
                  setMasterDataArticleGrossWeight(e.target.value)
                }
              />
            ...
            <li className="flex">
              ...
              <input
                type="text"
                className="input_center"
                value={`${Number(masterDataArticleNetWeight).toFixed(3)}`}
                onChange={(e) => setMasterDataArticleNetWeight(e.target.value)}
              />
              <span className="append">kg</span>
            </li>
